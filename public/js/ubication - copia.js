...
function loadDepartamentos() {
    let htmlDep = '<option value="default" selected disabled>Departamento</option>'
...
function loadProvincias(dept) {
    let htmlProv = '<option value="default" selected disabled>Provincia</option>'
...
function loadDistritos(prov) {
    let htmlDist = '<option value="default" selected disabled>Distrito</option>'
